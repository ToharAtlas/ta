...
public class information extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_register) {
            Intent i = new Intent(information.this, Registration.class);
            startActivity(i);
            finish();
        }
        if (id == R.id.nav_login) {
            Intent i = new Intent(information.this, Login.class);
            startActivity(i);
            finish();
        }
        ...
        if (id == R.id.nav_videos) {
            Intent i = new Intent(information.this, videos.class);
            startActivity(i);
            finish();
        }
        if (id == R.id.nav_celiac_day) {
            Intent i = new Intent(information.this, celiacDay.class);
            startActivity(i);
            finish();
        }
